...
- Given a data table and a research question, submit a short and concise data analysis report, including summary measures, plots, and a linear model. You can download everything you need from here: <https://github.com/uoelel/sqmb-s2>.
