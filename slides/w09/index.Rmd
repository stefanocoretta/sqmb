...
.bg-washed-blue.b--dark-blue.ba.bw2.br3.shadow-5.ph4.mt2[
**(3)** How do we fit interactions involving continuous predictors?
]
...
**`speech_rate_c`, a.k.a. $\beta_1$, is unchanged:**
...
Also not going to do the conditional posterior probability distribs yet.
Perhaps in Part 2, perhaps in the tutorial.

---
class: center middle reverse

# Part 2: Interactions <br> with a continuous predictor
