...
### Week 8: Interactions between predictors
...
-   How can we model the effects of multiple predictors?
-   How do we model interactions between two predictors?
-   How do we represent interactions using formulae?
-   What is a factorial design?

**Skills**

-   Join two or more data tables together using dplyr.
...
We will provide a list of data sets paired with hypotheses.
