...
The second summative will be in the form of a data analysis report. We will provide a list of data sets paired with hypotheses. You will choose one data set/hypothesis pair and, with it, conduct the full workflow of a Bayesian data analysis.
