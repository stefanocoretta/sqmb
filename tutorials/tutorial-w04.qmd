...
The `ifelse()` function works a bit like the English sentence "If X is true, do Y, otherwise do Z". The "X" has to be a "logical statement", i.e. an expression using **logical operators**.
